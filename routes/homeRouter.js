...
router.get('/', csrfProtection, controller.preIndex, controller.index)
router.post('/logout', controller.preLogout, controller.logout)
router.get('/:id/profile', csrfProtection, controller.checkAuth, controller.profile)
router.post('/deleteHook/:id/:id2', csrfProtection, controller.checkAuth, controller.deleteHook) //TODO fix crsf protection
